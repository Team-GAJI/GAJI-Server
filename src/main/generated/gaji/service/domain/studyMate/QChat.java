...
public class QChat extends EntityPathBase<Chat> {
    ...
    private static final long serialVersionUID = 1185133908L;
    ...
    public final ListPath<ChatUser, QChatUser> chatUserList = this.<ChatUser, QChatUser>createList("chatUserList", ChatUser.class, QChatUser.class, PathInits.DIRECT2);
