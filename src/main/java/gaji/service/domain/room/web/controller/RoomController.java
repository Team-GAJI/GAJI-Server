...
public class RoomController {
    ...
    public BaseResponse<Long> NoticeController(@PathVariable Long userId/*하드 코딩용, 추후 삭제*/, @RequestBody @Valid RoomRequestDto.RoomNoticeDto requestDto, @PathVariable Long roomId) {
        RoomNotice roomNotice = assignmentService.createNotice(roomId, userId, requestDto);
        return BaseResponse.onSuccess(roomNotice.getId());
    }
}
