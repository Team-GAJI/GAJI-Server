...
public enum RoomPostErrorStatus implements BaseErrorCodeInterface {
    ...
    _TROUBLE_POST_ALREADY_BOOKMARKED(HttpStatus.BAD_REQUEST, "TROUBLE_4004", "이미 북마크를 누른 게시글입니다."),
    _TROUBLE_POST_BOOKMARKED_NOT_FOUND(HttpStatus.BAD_REQUEST, "TROUBLE_4005", "북마크를 누르지 않은 상태입니다."),
